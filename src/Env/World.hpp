...
public:
 ...
 /**
  * @brief draws an array of cells_
  *
 ...
 /**
  * @brief initializes all attributes of world
  *
 ...
 /**
  * @brief associates a kind to a cell when it moves on one of the squares of its neighborhood
  *
 ...
 /**
   * @brief sets humidity on the water cells
   */
 void setHumidity();

 /**
   * @brief returns true if the position is grass
   *
   * @param a position (vec2d)
   *
 ...
 /**
   ...
   * @param a position (vec2d)
   *
   * @return a double: the humidity of a position
   */
